...
class AssociationDataset(Dataset):
    def __init__(self, args, train):
        ...
        if train:
            self.data = np.load(f'{self.data_path}/Within/association_within_{self.window_size}_train.npz')
        else:
            self.data = np.load(f'{self.data_path}/Within/association_within_{self.window_size}_test.npz')
