...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        if test_precision/len(test_dataloader) > best_test_precision:
            ...
            with open(f'checkpoints/Within_Wild/best_results_{args.name}.json', 'w') as f:
...
def parse_args():
    ...
    parser.add_argument('--name', type=str, default='Within', help='Experiment name')
    ...
    parser.add_argument('--hands', type=str, default='right', help='Hands to use: left, right, both')
